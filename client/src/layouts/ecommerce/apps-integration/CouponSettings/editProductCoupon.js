...
const EditProductCoupon = ({ couponData }) => {
  ...
  const handleSave = () => {
    ...
    const payload = {
      ...
      couponType: discountType.value === 'All' ? 'CART_VALUE' : 'CATEGORY',
      createdBy: uidx,
      offerName: offerName,
      ...
      applicableProductType: catArr,
      applicableBrand: manArr,
