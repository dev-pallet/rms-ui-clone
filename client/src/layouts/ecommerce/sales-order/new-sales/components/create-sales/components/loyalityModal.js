                    ...
                    {data?.data === null ? (
                      ...
                      <>
                        <SoftTypography fontSize="14px">
                          <b>Currency Code </b>: {data?.data?.currencyCode || 'NA'}
                        </SoftTypography>
                        <SoftTypography fontSize="14px">
                          <b> Redeemable Point </b>: {data?.data?.redeemablePoint || 'NA'}
                        </SoftTypography>
                        <SoftTypography fontSize="14px">
                          <b>Redeemable Point Value</b> : {data?.data?.redeemablePointValue || 'NA'}
                        </SoftTypography>
                        <SoftTypography fontSize="14px">
                          <b> Total Available Point </b>: {data?.data?.totalAvailablePoint || 'NA'}
                        </SoftTypography>
                        <SoftTypography color="error" fontSize="16px">
