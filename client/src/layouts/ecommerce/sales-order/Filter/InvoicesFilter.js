...
export const InvoicesAndReturnFilter = ({
  ...
  const [filterState, setFilterState] = useState({
    orderType: 0,
    ...(page === 'payment' ? { paymentStatus: 0 } : { orderStatus: 0 }),
    paymentMethod: 0,
    paymentMode: 0,
    startDate: 0,
    endDate: 0,
  ...
  const selectBoxArray = [
    ...
    startDateSelect,
    endDateSelect,
    page === 'payment' ? paymentStatusSelect : null, // except payment received page, show orderStatus instead of payment status
  ];
