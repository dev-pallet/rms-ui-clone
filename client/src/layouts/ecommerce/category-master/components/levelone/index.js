    ...
    <DashboardLayout>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={12} xl={12} m={3} className="main-card-level-box">
          ...
          <SoftTypography className="level-text">LEVEL-I</SoftTypography>
          <p className="ptext">Level one category feild</p>

          {newRow.map((e)=>{
            return(
              <>
                <SoftBox key={e.id} className="main-category-input-box">
          ...
          <SoftTypography className="main-add-text" onClick={()=>handleRow(1)} >Add more +</SoftTypography>
        </Grid>
      </Grid>
