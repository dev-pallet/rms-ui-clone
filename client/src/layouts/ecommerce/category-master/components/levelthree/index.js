    ...
    <DashboardLayout>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={12} xl={12} m={3} className="main-card-level-box">
          ...
          <SoftTypography className="level-text">LEVEL-III</SoftTypography>
          <>
        ...
        <Grid item xs={12} md={12} xl={12} m={3} className="main-card-level-box">
          ...
          <>
            <p className="ptext">Level two category feild</p>
            <SoftBox className="main-category-input-box">
              <SoftInput className="hoor"/>
            </SoftBox>
          </>
        ...
        <Grid item xs={12} md={12} xl={12} m={3} className="main-card-level-box">
          <p className="ptext-II">Level three category feild</p>
