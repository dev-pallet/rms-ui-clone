...
import ExpiryManagementMobileFilter from './mobile';

export default function ExpiryManagementFilter({ filterObjectMain, showSnackbar, isMobileDevice, pageState }) {
  ...
  const handleStartDate = (date) => {
    if (date) {
      ...
      if (validateDate(date)) {
        ...
        if(startDate !== ''){
          setStartDate('');
          removeSelectedFilter('startDate');
          return;
        }
        setStartDate('');
        return;
